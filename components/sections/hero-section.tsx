          ...
          >
            <picture>
              ...
              <img
                ...
                className="absolute -inset-[6%] block h-[112%] w-[112%] max-h-none max-w-none border-0 object-cover object-[center_35%] p-0 outline-none ring-0 sm:-inset-[4.5%] sm:h-[109%] sm:w-[109%] lg:-inset-[4%] lg:h-[108%] lg:w-[108%]"
                decoding="async"
                fetchPriority="high"
              />
            </picture>
